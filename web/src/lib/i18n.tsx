...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "discover.add": "Add",
    "discover.keywordInputPlaceholder": "keyword, or #tag1 #tag2, or comma-separated",
    ...
    "tasks.result": "Result",
    "tasks.date": "Date",
    "tasks.qualifiedOfTotal": "{qualified} qualified of {total} found",
    "tasks.lowYieldHint": "Low qualification rate — consider relaxing filters for this keyword",
  ...
  zh: {
    ...
    "discover.add": "添加",
    "discover.keywordInputPlaceholder": "关键词，或 #标签1 #标签2，或逗号分隔",
    ...
    "tasks.result": "结果",
    "tasks.date": "日期",
    "tasks.qualifiedOfTotal": "{qualified} 合格 / {total} 总计",
    "tasks.lowYieldHint": "合格率较低 — 建议放宽该关键词的筛选条件",
    "tasks.tabActive": "进行中",
